...
public class Administrador extends Empleado {
    ...
    public void agregarFuncion() throws IOException{
        ...
        try {
            ...
            //Validad que el usuario ingrese una fecha válida 
            try {
                //validad que se ingrese la fecha en el formato solicitado 
